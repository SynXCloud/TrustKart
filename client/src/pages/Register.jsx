      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-muted">
            Join TrustKart to start shopping safely
          </p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                type="text"
                required
                className="appearance-none rounded-lg relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm transition-colors duration-200"
        ...
        <div className="text-center mt-4 text-sm text-gray-600">
          ...
          <Link to="/login" className="font-medium text-primary hover:text-emerald-500 transition-colors">
            Sign in
          </Link>
        </div>
      </motion.div>
